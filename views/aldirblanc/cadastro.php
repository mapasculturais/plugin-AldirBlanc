...
<section class="lab-form-intro">
    <div class="box">
        <h1>Cadastro - Primeira tela após login</h1>
        <p>Olá, [Nome]!</p>
        ...
        <div class="lab-form-item">
            ...
            <ul class="lab-form-filter">
                ...
                <li><a id="option3" class="lab-form-option" href="<?= $this->controller->createUrl( 'tipo', ['individual'] ) ?>"><?php i::_e('Trabalhador da Cultura') ?></a></li>
            </ul>
        </div>
