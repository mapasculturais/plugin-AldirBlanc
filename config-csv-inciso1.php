...
return [ //Configuração dos campos
    ...
    "FLAG_ATUACAO_ARTES_CENICAS" => "field_56",
    "FLAG_ATUACAO_AUDIOVISUAL" => "field_56",
    "FLAG_ATUACAO_MUSICA" => "field_56",
    "FLAG_ATUACAO_ARTES_VISUAIS" => "field_56",
    "FLAG_ATUACAO_PATRIMONIO_CULTURAL" => "field_56",
    "FLAG_ATUACAO_MUSEUS_MEMORIA" => "field_56",
    "FLAG_ATUACAO_HUMANIDADES" => "field_56",
