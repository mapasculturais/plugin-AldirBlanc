...
return [
    ...
    'DETALHE1' => [
        ...
        'BEN_CODIGO_BANCO' => [ // Nome do campo da instituição bancária do beneficiário
            'length' => 3,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ...
        'BEN_AGENCIA_DIGITO' => [ // Nome do campo do dígito da agência bancária do beneficiário
            'length' => 1,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ],
        'BEN_CONTA' => [ // Nome do campo da conta bancária do beneficiário
            'length' => 12,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ],
        'BEN_CONTA_DIGITO' => [ // Nome do campo do dígito da conta bancária do beneficiário
            'length' => 1,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ...
        'BEN_NOME' => [ // Nome do campo nome do beneficiário
            'length' => 30,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
        ...
        'TIPO_CONTA' => [ // Nome do campo que contenha o tipo de conta do benefíciario, (Corrente, Poupança)
            'length' => 11,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
    ...
    'DETALHE2' => [
        ...
        'BEN_CPF' => [ // Nome do campo do CPF ou CNPJ do beneficiário, se atentar ao respondido no BEN_TIPO_DOC
            'length' => 14,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ],
        'BEN_ENDERECO_LOGRADOURO' => [ // Nome do campo do logradouro do beneficiário
            'length' => 30,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
        ],
        'BEN_ENDERECO_NUMERO' => [ // Nome do campo do numero endereço do beneficiário
            'length' => 5,
            'default' => null,
            'field_id' => null,
            'type' => 'int',
        ],
        'BEN_ENDERECO_COMPLEMENTO' => [// Nome do campo do complemento endereço do beneficiário
            'length' => 15,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
        ],        
        'BEN_ENDERECO_BAIRRO' => [ // Nome do campo do bairro do beneficiário
            'length' => 15,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
        ],        
        'BEN_ENDERECO_CIDADE' => [ // Nome do campo do cidade do beneficiário
            'length' => 20,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
        ...
        'BEN_ENDERECO_ESTADO' => [ // Nome do campo do estado do beneficiário
            'length' => 2,
            'default' => null,
            'field_id' => null,
            'type' => 'string',
